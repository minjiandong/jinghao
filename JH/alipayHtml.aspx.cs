...
namespace JH
{
    public partial class alipayHtml : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    Response.Write(Session["latitude"].ToString() + ";" + Session["longitude"].ToString());
                }
        ...
        void SavePage(int id)
        {
            ...
            if (m != null)
            {
                ...
                if (m.Play_type == "1")
                {
                    t = "<a class=\"aActivate\" style=\"width:80%;\" href=\"/alipayBuy?money=" + m.Monetary.ToString() + "&Scenic_id=" + m.id.ToString() + "\">立即购买</a>";
                ...
                {
                    t = "<a class=\"aBuy\" href=\"/alipayBuy?Scenic_id=" + m.id + "\">立即购买</a>";

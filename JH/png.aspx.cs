...
namespace JH
{
    public partial class png : System.Web.UI.Page
    {
        ...
        private void CreateCheckCodeImage(string checkCode)
        {
            ...
            Bitmap image = new Bitmap(iImageWidth, 45);
            ...
            try
            {
                ...
                for (int i = 0; i < checkCode.Length; i++)
                {
                    ...
                    {
                        Font font = new System.Drawing.Font("楷体", 20, (FontStyle.Bold));
                        Rectangle rc = new Rectangle(xLeft, 0, iWordWidth, image.Height);
                    ...
                    {
                        Font font = new System.Drawing.Font("宋体", 20, (System.Drawing.FontStyle.Bold));
                        Rectangle rc = new Rectangle(xLeft, 0, iWordWidth, image.Height);
                    ...
                    {
                        Font font = new System.Drawing.Font("黑体", 20, (System.Drawing.FontStyle.Bold | System.Drawing.FontStyle.Bold));
                        Rectangle rc = new Rectangle(xLeft, 0, iWordWidth, image.Height);

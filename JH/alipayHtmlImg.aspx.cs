...
namespace JH
{
    public partial class alipayHtmlImg : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //            if (jo1["subscribe"].ToString() == "0")
                //            {
                //                Response.Redirect("https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzAxNzQ3ODgzNg==#wechat_redirect");
                //            }
                //            else
                //            {
                //                string _unionid = jo1["unionid"].ToString();
                //                if (!isbind(_unionid))
                //                {
                //                    Response.Redirect("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx6fb51a67c530c955&redirect_uri=https://cloud.jhlxw.com/userbind.aspx&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect");
                //                }
                //            }
                //        }
                //    }
                ...
                //catch (Exception ex)
                //{
                //    Response.Write(ex.Message + ";" + errmsg);
                //}
        ...
        bool isbind(string openid)
        {
            ...
            //object obj = DBUtility.DALHelper.dbHelper.ExecuteScalar(CommandType.Text, "select count(1) from JH_USERS where openid='" + openid + "'");
        ...
        void SavePage(int id)
        {
            ...
            if (m != null)
            {
                ...
                imageUrl = "https://cloud.jhlxw.com/app" + m.MapImageUrl;
                is_bluetooth = m.is_bluetooth;
                if (string.IsNullOrWhiteSpace(m.MapImageUrl))
                    Response.Redirect("alipayHtml?id=" + id);
            }
        }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MapHtml.aspx.cs" Inherits="JH.MapHtml" %>
...
<!--头部弹出层-->
        ...
        <div id="m-tool-Dom" class="m-tool" style="width:100%;">
            <div class="toolNav">
                <ul>
                    ...
                    <li class="" style="display:none;"><span>语音类型</span></li>
                </ul>
            </div>
        ...
        <div id="menu-list" class="menu-list">
            ...
            <dl class="selectLanguage" style="display:none;">
                <dt><%=title %>  <a class="amap-info-close" href="javascript: void(0)" style="right: 5px;"></a></dt>
                <dd class="listDetail">
                    <ul class="scroll">


                        <li class="liFlag liSelect"
                            audioid="1-2">


                            <i style="background-image: url('/images/fileOpviewFile.png');"></i>
        ...
        <div class="keyPop keyPop_Code " style="height: 6.00rem;">
           ...
           <dl>
              <dt>授权激活</dt>
               ...
               <dd class=" ddOnlyAct" style="padding:10px 30px;font-size:0.25rem; height:40px;line-height:40px; margin-bottom:60px;text-align:left;">
    ...
    wx.ready(function () {  
        wx.stopSearchBeacons({
            complete: function (argv) {
                if (argv.errMsg == "stopSearchBeacons:ok"){

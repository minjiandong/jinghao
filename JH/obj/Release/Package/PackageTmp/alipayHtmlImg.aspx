<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="alipayHtmlImg.aspx.cs" Inherits="JH.alipayHtmlImg" %>
	...
	<!--头部弹出层-->
        ...
        <script type="text/javascript">
            ...
            <dl class="selectSpots">
                <dt>
                     景点列表<a class="amap-info-close" href="javascript: void(0)" style="right: 5px;"></a>
            ...
            <dl class="selectLanguage">
                <dt>周边服务 <a class="amap-info-close" href="javascript: void(0)" style="right: 5px;"></a></dt>
                <dd class="listDetail">
